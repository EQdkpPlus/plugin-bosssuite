<?php
$loot = array(
	array( "id" => "51007", "qual" => "4", "name" => "Äthergetränkte Armschienen" ),
	array( "id" => "51005", "qual" => "4", "name" => "Handschuhe der gebrochenen Finger" ),
	array( "id" => "51009", "qual" => "4", "name" => "Brustschutz des fehlgeschlagenen Experiments" ),
	array( "id" => "51002", "qual" => "4", "name" => "Taldrons kurzsichtiger Helm" ),
